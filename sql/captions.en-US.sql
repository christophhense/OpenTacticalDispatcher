...
('permission_unit', 'Unit'),
('permission_statistics', 'Statistics'),
('permission_service_user', 'Service User'),
('Table', 'Table'),
('Table-ID', 'Table-ID'),
...
('SVN project files still exist. Update is only simulated.', 'SVN project files still exist. Update is only simulated.'),
('Updates', 'Updates'),

...
$GLOBALS['TAB_VISIBLE_SINGLE_ONLY']						= 1;
$GLOBALS['TAB_VISIBLE_MULTI_ONLY']						= 2;
$GLOBALS['TAB_VISIBLE_YES']								= 3;

$GLOBALS['TAB_ADDITIONAL_TICKETS_NO']					= 0;
$GLOBALS['TAB_ADDITIONAL_TICKETS_SINGLE_ONLY']			= 1;
$GLOBALS['TAB_ADDITIONAL_TICKETS_MULTI_ONLY']			= 2;
$GLOBALS['TAB_ADDITIONAL_TICKETS_YES']					= 4;

$GLOBALS['TAB_CONFIG_NO']								= 0;
$GLOBALS['TAB_CONFIG_VISIBILITY']						= 1;
$GLOBALS['TAB_CONFIG_ADD_EDIT']							= 2;
